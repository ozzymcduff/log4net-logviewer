...
namespace IntegrationTests
{
  ...
  {
    private static readonly string _buffer = @"<log4j:event logger=""IntegrationTests.LogTests"" timestamp=""1300902418948"" level=""ERROR"" thread=""7""><log4j:message>test</log4j:message><log4j:properties><log4j:data name=""log4net:UserName"" value=""WIN-H5J0KF8GKP6\Administrator"" /><log4j:data name=""log4jmachinename"" value=""WIN-H5J0KF8GKP6"" /><log4j:data name=""log4japp"" value=""IsolatedAppDomainHost: IntegrationTests"" /><log4j:data name=""log4net:HostName"" value=""WIN-H5J0KF8GKP6"" /></log4j:properties><log4j:locationInfo class=""IntegrationTests.LogTests"" method=""TestLog"" file=""C:\projects\LogViewer\IntegrationTests\LogTests.cs"" line=""18"" /></log4j:event>";

    [Ignore("Used to generate log file"), Test]
    public void TestLog()
    {
      var log = LogManager.GetLogger(typeof(LogTests));
      log.Error("test");
    ...
    public void Parse()
    {
      ...
      Assert.That(entry.UserName, Is.EqualTo(@"WIN-H5J0KF8GKP6\Administrator"));
      Assert.That(entry.MachineName, Is.EqualTo(@"WIN-H5J0KF8GKP6"));
    ...
    {
      var line =
        @"<log4j:event logger=""IntegrationTests.LogTests"" timestamp=""1300909721869"" level=""ERROR"" thread=""7""><log4j:message>msg</log4j:message><log4j:properties><log4j:data name=""log4net:UserName"" value=""WIN-H5J0KF8GKP6\Administrator"" /><log4j:data name=""log4jmachinename"" value=""WIN-H5J0KF8GKP6"" /><log4j:data name=""log4japp"" value=""IsolatedAppDomainHost: IntegrationTests"" /><log4j:data name=""log4net:HostName"" value=""WIN-H5J0KF8GKP6"" /></log4j:properties><log4j:throwable>System.Exception: test</log4j:throwable><log4j:locationInfo class=""IntegrationTests.LogTests"" method=""TestLog"" file=""C:\projects\LogViewer\IntegrationTests\LogTests.cs"" line=""27"" /></log4j:event>";
